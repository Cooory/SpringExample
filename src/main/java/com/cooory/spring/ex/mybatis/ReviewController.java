package com.cooory.spring.ex.mybatis;
...
import com.cooory.spring.ex.mybatis.service.ReviewService;
...
public class ReviewController {
	...
	// 리퀘스트 파라미터로 전달 된 id와 일치하는 리뷰 정보를 json으로 response에 담는다
